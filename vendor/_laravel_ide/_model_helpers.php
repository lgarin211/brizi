...
namespace TCG\Voyager\Models {
     ...
     * @property mixed $policy_name
     * @property mixed $model_name
     * @property mixed $icon
     * @property mixed $display_name_plural
     * @property mixed $display_name_singular
     * @property mixed $slug
     * @property mixed $name
     * @property int $id
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereSlug($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereDisplayNameSingular($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereDisplayNamePlural($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereIcon($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereModelName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType wherePolicyName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereController($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType withTranslation()
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType withTranslations()
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<DataType>|DataType query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
